                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="display-details">
                                        <h3><strong> @lang('crud.all_payment_types.inputs.payment_name'): </strong>
                                            {{ $paymentTypes->payment_name ?? '-' }} </h3>
                                        <h3><strong> @lang('crud.all_payment_types.inputs.description'): </strong>
                                            {{ $paymentTypes->description ?? '-' }}</h3>
                                    </div>
                                    <div class="mt-4">
                                        <a
