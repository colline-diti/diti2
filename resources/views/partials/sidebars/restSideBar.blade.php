        ...
        <div class="nano-content">
            <ul>
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-shopping-cart"></i> Stock Management<span
                    ...
                    <ul>
                         <li><a href="{{ route('stock-tables.index') }}" ><i class="ti-tag"></i> Stock Status</a></li>
                        <li><a href="{{ route('item-categories.index') }}"><i class="ti-tag"></i>Stock Settings</a></li>                       
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i> Reports <span
                    ...
                    <ul>                       
                        ...
                        <li><a href="{{ route('res-products.dailyLogs') }}"> <i class="ti-tag"></i>Charts</a></li>                                                                            
                    </ul>
                </li>    
            </ul>
        </div>
